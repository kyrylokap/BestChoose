...
const HistoryHeader = ({ onBack }: { onBack: () => void }) => (
  <div className="flex items-center gap-4 mb-8">
    ...
    <div>
      <h3 className="text-2xl font-semibold text-slate-900">Historia wywiadów</h3>
...
const HistoryCard = ({ item }: { item: HistoryItem }) => (
  <div className="group flex flex-col gap-4 rounded-3xl border border-slate-100 bg-white p-5 shadow-sm transition hover:border-blue-100 hover:shadow-md sm:flex-row sm:items-center sm:justify-between">
